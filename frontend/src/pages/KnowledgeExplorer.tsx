...
export function KnowledgeExplorer() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-3xl font-bold">Knowledge Explorer</h1><p className="text-muted-foreground mt-1">Explore entity relationships across all investigations</p></div>
